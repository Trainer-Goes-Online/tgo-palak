...
const PRICE_INR = Number(process.env.PRICE_INR ?? process.env.NEXT_PUBLIC_PRICE_INR ?? 499);

export const pricing = {
  /** Price in rupees (major units) — e.g. 499. */
  inr: Number.isFinite(PRICE_INR) && PRICE_INR > 0 ? PRICE_INR : 499,
